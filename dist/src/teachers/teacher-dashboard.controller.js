...
const teacher_dashboard_service_1 = require("./teacher-dashboard.service");
let TeacherDashboardController = class TeacherDashboardController {
    constructor(dashboardService) {
        this.dashboardService = dashboardService;
    }
    overview(req) {
        return this.dashboardService.overview(req.user.sub);
    }
};
...
], TeacherDashboardController.prototype, "overview", null);
exports.TeacherDashboardController = TeacherDashboardController = __decorate([
    ...
    __metadata("design:paramtypes", [teacher_dashboard_service_1.TeacherDashboardService])
